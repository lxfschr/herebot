...
if (!process.env.clientId || !process.env.clientSecret) {
  ...
  if (process.env.studio_token) {
      controller.hears(['<!here>'],['message','message_received', 'ambient'],async(bot, message) => {
          console.log("adbg any message:", message);
          if (message && message.event && message.event.text.includes("<!here>")) {
            bot.reply(message, "Hello human, please make sure you are only using \@here for urgent, time sensitive annoucements that everyone in this channel needs to see right away. It sends a notification to everyone in this channel who is signed into Slack and can distrupt their work.");
          }
      });
